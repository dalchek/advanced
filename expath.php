...
* It uses the Expath library, an event-based parser.
*/

// Function for handling the open tag:
function handle_open_element($p, $element, $attributes) {

	// Do diferent things based upon the element:
	switch($element) {
		...
		echo "<p>Chapter {$attributes['NUMBER']}:</p>";
		break;

		case 'COVER': // Show the image... & get the image info
...
} // End of hendle_close_element() function
