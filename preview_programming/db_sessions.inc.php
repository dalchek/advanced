 ...
 *  stroing session data in a database.
 *  This page also start the session
 */

// Global variable used for the database
// connectons in all session functions:
$sdbc = NULL;
...
function open_session() {
    ...
    $sdbc = mysqli_connect('localhost', 'bookPHP', 'bookPHP', 'advanced');
    return true;
...
// This functio takes one argument: the session ID.
